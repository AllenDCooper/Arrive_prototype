...
import { Row, Col, Offcanvas, Form, FormControl, Button, Container, Navbar, Nav, NavDropdown } from 'react-bootstrap';
      ...
      <Container fluid style={{ color: "#fff" }}>
        <Row style={{ width: '100%', paddingTop: '10px', fontWeight: '600' }}>
          ...
          <Col xs={4} style={{ textAlign: 'center', fontSize: '20px' }}>
            <Navbar.Brand style={{ color: "#fff" }}>Courses</Navbar.Brand>
          </Col>
          <Col xs={4} style={{ textAlign: 'right', fontSize: '20px' }}>
            <span><img alt='add course icon' src='https://institutional-web-assets-share.s3.amazonaws.com/iClicker/student/images/plus.svg' style={{ height: '19px', width: '19px' }} /></span>
          </Col>
        </Row>
        <Navbar.Offcanvas
          id="offcanvasNavbar"
