      ...
      <Container>
        ...
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="formBasicPassword" style={{ color: '#fff', marginBottom: '20px' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <Button
                ...
                size="md"
                type="submit"
                style={{ width: '100%', minWidth: '150px', maxWidth: '300px', height: '45px', borderRadius: '40px', color: '#1565c0' }}
                block
              >
                Sign In
              </Button>
            ...
            <div style={{ margin: '60px 0px', background: 'none', textAlign: 'center' }}>
              ...
              {/* <p className="ride-line"></p> */}
              {/* <p style={{ background: 'none', color: 'rgba(255,255,255,0.75)' }}>Or sign in with</p>
              <p className="ride-line" style={{ float: 'right' }}></p> */}
              <Button
                variant="light"
                // size="md"
